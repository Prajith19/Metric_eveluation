...
def epi_case_111(state, enabled, retry_count, priority):
    """Evaluate Execution Path Integrity case 111 (Crosshair-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def epi_case_112(state, enabled, retry_count, priority):
    """Evaluate Execution Path Integrity case 112 (Crosshair-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def epi_case_113(state, enabled, retry_count, priority):
    """Evaluate Execution Path Integrity case 113 (Crosshair-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def epi_case_114(state, enabled, retry_count, priority):
    """Evaluate Execution Path Integrity case 114 (Crosshair-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
